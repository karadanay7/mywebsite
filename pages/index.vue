<template>
  <div class="relative bg-black h-full">
    <div class="flex flex-col lg:flex-row h-full">
      <!-- Left Section -->
      <div
        class="w-full lg:basis-1/2 flex flex-col gap-5 justify-center p-8 lg:p-4 z-20"
      >
        <div
          class="flex flex-col items-start justify-center pt-0 md:pt-32 gap-5 lg:pl-12"
        >
          <h2 class="text-xl md:text-2xl lg:text-3xl text-white">
            Aysegul Karadan
          </h2>
          <h1 class="text-3xl md:text-4xl lg:text-6xl text-white">
            Full-Stack Developer
          </h1>

          <p class="text-white">
            As a Full-Stack Developer with a solid background in industrial
            engineering and expertise in technologies like Vue.js, Nuxt.js,
            .NET, and Blazor, I am passionate about crafting impactful digital
            experiences. I specialize in both frontend and backend technologies,
            leveraging my skills to build innovative web solutions.
          </p>
          ...
          <div class="flex pt-8 items-start gap-6">
            ...
            >
              <UIcon
                name="i-uil-linkedin"
                class="text-5xl hover:text-primary text-white"
                dynamic
              />
            </NuxtLink>
            <NuxtLink
      ...
      <div class="hidden w-full lg:basis-1/2 justify-center p-8 lg:p-4 z-20">
        <h3 class="text-xl md:text-2xl lg:text-3xl mb-4 text-white">
          Skills & Expertise
        </h3>
        <ul class="list-disc list-inside mb-8 text-white">
          <li>
            Full-Stack Development with Nuxt.js, Vue.js, ASP.NET Core, Blazor
          </li>
